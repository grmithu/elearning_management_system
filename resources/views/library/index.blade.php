            ...
            @foreach ($jobs as $index => $job)
                <div class="card col-12 col-lg-10 offset-lg-1 p-3 rounded-3 shadow-sm">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-12 col-md-4 text-center text-md-end mt-4 my-md-1">
                            <button class="btn btn-info text-light" type="button" data-bs-toggle="collapse" data-bs-target="#job_{{ $index }}_details" aria-expanded="false" aria-controls="job_{{ $index }}_details">Details</button>
