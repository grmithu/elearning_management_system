...
<div class="card p-3">
    <div class="card-header">
        <h5 class="card-title pb-0 fs-4">Create New Class Test</h5>
        <p class="small">Enter Class Test Information</p>
    </div>
    <div class="card-body mt-4">
        <form class="row g-3 needs-validation" method="POST" action="{{ route('class-test.store', $course->id) }}" novalidate enctype="multipart/form-data">
            @csrf
