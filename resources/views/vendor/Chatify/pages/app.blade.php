    ...
    <div class="messenger-listView">
        ...
        <div class="m-header">
            ...
            <div class="messenger-listView-tabs">
                <a href="javascript:void(0)" @if($type == 'user') class="active-tab" @endif data-view="users">
                    <span class="far fa-user"></span> People</a>
{{--                <a href="javascript:void(0)" @if($type == 'group') class="active-tab" @endif data-view="groups">--}}
        ...
        <div class="m-header m-header-messaging">
            <nav class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                ...
                <div class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                    ...
                    <div class="avatar av-s header-avatar" style="margin: 0px 10px; margin-top: -5px; margin-bottom: -5px; background-image: url({{ asset('dashboard/assets/img/logo.png') }})">
                    </div>
                    <a href="javascript:void(0)" class="user-name show-infoSide">{{ config('chatify.name') }}</a>
                </div>
                {{-- header buttons --}}
                <nav class="m-header-right">
